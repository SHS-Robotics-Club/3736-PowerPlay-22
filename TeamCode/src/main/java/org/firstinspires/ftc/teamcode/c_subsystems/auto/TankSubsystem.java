...
/**
 * A subsystem that uses the {@link TankDrive} class.
 * This periodically calls {@link TankDrive#update()} which runs the internal
 * state machine for the tank drive. All movement/following is async to fit the paradigm.
 */
public class TankSubsystem extends SubsystemBase {
	private final TankDrive drive;
	private final boolean   fieldCentric;

	public TankSubsystem(TankDrive drive, boolean isFieldCentric) {
		this.drive   = drive;
